    ...
    >
      ...
      <label className="mt-5 flex items-start gap-3">
        ...
        <span className="text-xs leading-relaxed text-slate-400">
          I consent to O2MackDrive using my details to respond to this inquiry, as
          described in the{" "}
          <Link href="/privacy" className="font-bold text-slate-200 underline underline-offset-2 hover:text-white">
            Privacy Policy
          </Link>.
        </span>
      </label>
