    ...
    <div>
      ...
      {preview ? (
        ...
        <button
          ...
          aria-label="Upload a photo of your car, or drag and drop one here"
          className="group aspect-[21/9] w-full border-2 border-dashed border-slate-200 bg-slate-50 flex items-center justify-center cursor-pointer hover:border-slate-400 hover:bg-slate-100 transition shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-900"
        >
