      ...
      <Container>
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-[radial-gradient(circle_at_50%_20%,rgba(249,115,22,0.16),transparent_24rem),linear-gradient(135deg,#07141d,#0d1a28)] p-4 text-center shadow-2xl shadow-black/50 sm:p-8">
          ...
          <div className="relative mx-auto max-w-3xl py-8 sm:py-10">
            <p className="text-xs font-black uppercase tracking-[0.28em] text-orange-300">Financing counter</p>
            <h2 className="mt-4 text-2xl font-black leading-tight text-white sm:text-4xl">{financing.headline}</h2>
            <p className="mt-4 text-sm leading-7 text-slate-300 sm:text-base">{financing.disclaimer}</p>
            <div className="mt-8">
