        ...
        <div className="grid gap-10 md:grid-cols-4 lg:gap-16 2xl:gap-20">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/refund-policy" className="text-xs font-medium text-slate-400 hover:text-white">
                  Refund Policy
                </Link>
              </li>
              <li>
                <Link href="/cookie-policy" className="text-xs font-medium text-slate-400 hover:text-white">
                  Cookie Policy
                </Link>
              </li>
            </ul>
